...
if ((CMAKE_GENERATOR_PLATFORM STREQUAL "x64") OR ("${CMAKE_C_COMPILER_ARCHITECTURE_ID}" STREQUAL "x64"))
    find_library(DIASDK_GUIDS_LIBRARY NAMES diaguids.lib PATHS ${DIASDK_INCLUDE_DIR}/../lib/amd64 REQUIRED)
    find_file(DIASDK_DLL NAMES msdia140.dll PATHS ${DIASDK_INCLUDE_DIR}/../bin/amd64 REQUIRED)
elseif ((CMAKE_GENERATOR_PLATFORM STREQUAL "ARM") OR ("${CMAKE_C_COMPILER_ARCHITECTURE_ID}" STREQUAL "ARM"))
    find_library(DIASDK_GUIDS_LIBRARY NAMES diaguids.lib PATHS ${DIASDK_INCLUDE_DIR}/../lib/arm REQUIRED)
elseif ((CMAKE_GENERATOR_PLATFORM MATCHES "ARM64.*") OR ("${CMAKE_C_COMPILER_ARCHITECTURE_ID}" MATCHES "ARM64.*"))
    find_library(DIASDK_GUIDS_LIBRARY NAMES diaguids.lib PATHS ${DIASDK_INCLUDE_DIR}/../lib/arm64 REQUIRED)
else ((CMAKE_GENERATOR_PLATFORM STREQUAL "x64") OR ("${CMAKE_C_COMPILER_ARCHITECTURE_ID}" STREQUAL "x64"))
    find_library(DIASDK_GUIDS_LIBRARY NAMES diaguids.lib PATHS ${DIASDK_INCLUDE_DIR}/../lib REQUIRED)
