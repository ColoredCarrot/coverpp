# Source: https://github.com/microsoft/DirectXShaderCompiler/blob/main/cmake/modules/FindDiaSDK.cmake
# https://github.com/microsoft/DirectXShaderCompiler/blob/f94fe829f7944c97ea2646fc7950ae4e367d7136/cmake/modules/FindDiaSDK.cmake
...
if ((CMAKE_GENERATOR_PLATFORM STREQUAL "x64") OR ("${CMAKE_C_COMPILER_ARCHITECTURE_ID}" STREQUAL "x64"))
    find_library(DIASDK_GUIDS_LIBRARY NAMES diaguids.lib HINTS ${DIASDK_INCLUDE_DIR}/../lib/amd64 REQUIRED)
    find_file(DIASDK_DLL NAMES msdia140.dll HINTS ${DIASDK_INCLUDE_DIR}/../bin/amd64 NO_DEFAULT_PATH REQUIRED)
elseif ((CMAKE_GENERATOR_PLATFORM STREQUAL "ARM") OR ("${CMAKE_C_COMPILER_ARCHITECTURE_ID}" STREQUAL "ARM"))
    find_library(DIASDK_GUIDS_LIBRARY NAMES diaguids.lib HINTS ${DIASDK_INCLUDE_DIR}/../lib/arm REQUIRED)
    find_file(DIASDK_DLL NAMES msdia140.dll HINTS ${DIASDK_INCLUDE_DIR}/../bin/arm NO_DEFAULT_PATH REQUIRED)
elseif ((CMAKE_GENERATOR_PLATFORM MATCHES "ARM64.*") OR ("${CMAKE_C_COMPILER_ARCHITECTURE_ID}" MATCHES "ARM64.*"))
    find_library(DIASDK_GUIDS_LIBRARY NAMES diaguids.lib HINTS ${DIASDK_INCLUDE_DIR}/../lib/arm64 REQUIRED)
    find_file(DIASDK_DLL NAMES msdia140.dll HINTS ${DIASDK_INCLUDE_DIR}/../bin/arm64 NO_DEFAULT_PATH REQUIRED)
else ((CMAKE_GENERATOR_PLATFORM STREQUAL "x64") OR ("${CMAKE_C_COMPILER_ARCHITECTURE_ID}" STREQUAL "x64"))
    find_library(DIASDK_GUIDS_LIBRARY NAMES diaguids.lib HINTS ${DIASDK_INCLUDE_DIR}/../lib REQUIRED)
    find_file(DIASDK_DLL NAMES msdia140.dll HINTS ${DIASDK_INCLUDE_DIR}/../bin NO_DEFAULT_PATH REQUIRED)
...
find_package_handle_standard_args(DiaSDK  DEFAULT_MSG
        DIASDK_LIBRARIES DIASDK_INCLUDE_DIR DIASDK_DLL)

mark_as_advanced(DIASDK_INCLUDE_DIRS DIASDK_LIBRARIES DIASDK_DLL)
